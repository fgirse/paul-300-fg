...
import { FC, ReactNode, DetailedHTMLProps, HTMLAttributes, ElementType, ComponentProps } from 'react';
...
export declare type StyledComponentName = keyof IntrinsicSxElements | keyof JSX.IntrinsicElements;
...
export declare type StyledComponentsDict = {
...
declare type StyledDiv = StyledComponent<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, ThemedProps, Theme>;
export declare const Styled: StyledDiv & StyledComponentsDict;
export declare const components: StyledComponentsDict;
