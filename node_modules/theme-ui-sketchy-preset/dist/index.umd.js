(function (global, factory) {
  ...
  (global = global || self, global.themeUiSketchyPreset = factory());
}(this, (function () {
  function _extends() {
  ...
  var theme = {
    ...
    buttons: {
      ...
      danger: _extends(_extends({}, buttonStyles), {}, {
        borderColor: "primary",
        backgroundColor: "primaryLight"
      }),
      info: _extends(_extends({}, buttonStyles), {}, {
        borderColor: "blueDark",
        backgroundColor: "blue"
      }),
      warning: _extends(_extends({}, buttonStyles), {}, {
        borderColor: "yellowDark",
        backgroundColor: "yellow"
      }),
      success: _extends(_extends({}, buttonStyles), {}, {
    ...
    forms: {
      ...
      radio: _extends({
        ...
        "input:focus ~ &": {
          ...
          border: function border(theme) {
            return "2px solid " + theme.colors.text;
          }
        },
        "> path": {
          fill: "none",
    ...
    alerts: {
      danger: _extends(_extends({}, alertStyles), {}, {
        borderColor: "primary",
        backgroundColor: "primaryLight"
      }),
      info: _extends(_extends({}, alertStyles), {}, {
        borderColor: "blueDark",
        backgroundColor: "blue"
      }),
      warning: _extends(_extends({}, alertStyles), {}, {
        borderColor: "yellowDark",
        backgroundColor: "yellow"
      }),
      success: _extends(_extends({}, alertStyles), {}, {
        borderColor: "greenDark",
        backgroundColor: "green"
      })
    },
